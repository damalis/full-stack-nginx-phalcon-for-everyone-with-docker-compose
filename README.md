# [full stack nginx Phalcon for everyone with docker compose](https://github.com/damalis/full-stack-nginx-phalcon-for-everyone-with-docker-compose)

If You want to build a website with Phalcon at short time;

#### Full stack Nginx Phalcon:
<p align="left"> <a href="https://phalcon.io" target="_blank" rel="noreferrer"> <img src="https://avatars.githubusercontent.com/u/1221505?s=200&v=4" alt="Phalcon" height="40" width="40"/> </a>&nbsp;&nbsp;&nbsp; 
...
```
git clone https://github.com/damalis/full-stack-nginx-phalcon-for-everyone-with-docker-compose.git
```

Open a terminal and `cd` to the folder in which `docker-compose.yml` is saved and run:

```
cd full-stack-nginx-phalcon-for-everyone-with-docker-compose
chmod +x install.sh
./install.sh
```
...
[https://docs.phalcon.io/5.9/db-layer/](https://docs.phalcon.io/5.9/db-layer/)
...
[Redis Cache](https://docs.phalcon.io/5.9/cache/?h=redis#redis); The Phalcon\Cache\Cache is a component that offers a lightweight yet flexible caching mechanism to be used with your Phalcon applications.
...
[https://docs.phalcon.io/5.9/db-models-cache/](https://docs.phalcon.io/5.9/db-models-cache/)
